...
public class AppointmentServiceTest {
  ...
  void getDoctorById() {
    ...
    Assertions.assertEquals(appointments.get(0).getAppointmentDateTime(),
        saveAppoint.getContent().get(0).appointmentDateTime());
  ...
  void testAppointmentResponse()
    ...
    Method toResponse = AppointmentService.class.getDeclaredMethod("toResponse", Appointment.class);

    toResponse.setAccessible(true);

    AppointmentResponse appointmentResponse = (AppointmentResponse) toResponse.invoke(service, appointment);

    Assertions.assertEquals(appointmentResponse.doctorId(), appointment.getDoctorId());
  }
